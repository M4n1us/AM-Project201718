...
\RequirePackage{enumerate} %Aufzählung
...
\begin{document}
	...
	\begin{enumerate} [i]
		\item $f'(x_{0})$ heißt erste Ableitung an der Stelle $x_{0}$
		\item Eine differenzierbar Funktion ist dort im Intervall stetig. Das heißt eine stetige Funktion kann differenzierbar sein, muss es aber nicht.
	\end{enumerate}
\end{document}