...
\end{tikzpicture}
\caption{Darstellung einer konstanten Folge}
\end{figure}
\FloatBarrier
\newpage
...
\end{tikzpicture}
\caption{Darstellung einer alternierenden Folge}
\end{figure}
\FloatBarrier
...
\end{tikzpicture}
\caption{Darstellung einer arithmetischen Folge}
\end{figure}
\FloatBarrier
\newpage
...
\end{tikzpicture}
\caption{Darstellung einer geometrischen Folge}
\end{figure}
\FloatBarrier
\end{enumerate}
